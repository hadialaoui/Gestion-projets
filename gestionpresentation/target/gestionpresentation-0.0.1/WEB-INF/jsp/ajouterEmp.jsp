...
<body>
	...
	<div class="container style-container">
		<br />
		<div class="card">
			<div class="card-header text-center">Nouveau employee</div>
			<div class="card-body">
				<form action="listEmployee" method="post">
					<div class="row">
						<div class="offset-lg-2 col-lg-8">
							<div class="form-group">
								<label class="control-label">Refog</label> <input type="text"
									name="refog" value="${employee.refog}" class="form-control" />
								<span></span>
							</div>
							<div class="form-group">
								<label class="control-label">Nom</label> <input type="text"
									name="nom" value="${employee.nom}" class="form-control"
									required /> <span></span>
							</div>

							<div class="form-group">
								<label class="control-label">Prenom</label> <input type="text"
									name="prenom" value="${employee.prenom}" class="form-control" />
								<span></span>
							</div>

							<div class="form-group">
								<label class="control-label">Statut</label> <input type="text"
									name="statut" value="${employee.statut}" class="form-control" />
								<span></span>
							</div>

							<div class="form-group">
								<label class="control-label">Date Integration</label> <input
									type="Date" name="dateIntegration"
